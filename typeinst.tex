...
Easycrypt se utiliza en la terminal de comando y tiene un funcionamiento muy simple pero poco intuitivo; Se ingresa el codigo deseado y al ejecutarlo este analiza linea por linea hasta llegar a un resultado o error. Por eso es mas viable utilizar EMACS.\cite{link2}. Utiliza archivos *.ec  .Es un programa en el cual la visualizacion de los elementos es mas amigable con el usuario. Tiene por un lado el archivo selecionado y por otro las ejecuciones realizadas. La interfaz permite analizar el archivo paso por paso o ejectutarlo completamente.
