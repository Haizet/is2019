...
Let $G_1$ , $G_2$ be two games and A, B, and F be events such that
...
Las respuestas que brinda Easycrypt son proof sketches que incrementan la confianza en las mismas produciendo pruebas verificables independientes y tambien permite generar estas pruebas en formato COQ, para que luego, el usuario si lo desea las ejecute en dicho formato con dicho programa.\cite{article4}
