...
\begin{abstract}    
\href{https://github.com/EasyCrypt/easycrypt}{EasyCrypt} es un conjunto de herramientas para razonar sobre las propiedades reales de los cálculos probabilísticos con código contradictorio. Su aplicación principal es la construcción y verificación de pruebas criptográficas basadas en juegos. 
...
\begin{itemize}
	\item Poner referencias (lucas) Falta ponerlo en los textos donde los uses asi cuando revisemos sabemos donde buscar
	\item checker que aticle 4 es distinto del 6
	\item art9 lo cambien por una href en el contexto
	...
	\item Aprender cramer-shoup para el oral y terminar el caso de estudio seleccionado (avanze de cramer-shoup teorico)
...
El desarrollo de \href{https://www.easycrypt.info/trac/}{EasyCrypt} se inició en 2009, y el prototipo inicial se usó para probar la seguridad de varias construcciones, incluso el esquema de cifrado Cramer-Shoup(*), el diseño de la función de hash iterativa Merfle-Damgaard(**) y el esquema de cifrado ZEAP(***). EasyCrypt ha sido desarrollado inicialmente por el Instituto de Software IMDEA e Inria. Actualmente se desarrolla en el instituto IMDEA Software, Inria y École Polytechnique. EasyCrypt es un proyecto de software libre, distribuido bajo los términos de la licencia CeCILL-B, y su código fuente está accesible desde la página del proyecto. 
...
En ambos programas la eficiencia de calculos no puede ser expresada formalmente porque sus locas identifican términos hasta calculos, por ejemplo, ($\lambda$x. x+x) no puede ser distinguido de el valor 2.\cite{article8}
...
Los MAC cuentan con con 3 algoritmos (generador de clave, tageo y de verificación). Estos deben cumplir con las siguientes características: deben ser correctos, seguros y determinísticos. A diferencia de los BCB que solo requieren ser seguros. 
